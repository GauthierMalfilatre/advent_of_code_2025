## Advent of Code day3 : Ex1 - Gauthier Malfilatre
...
def biggest_number(line: str, r: int = 2) -> int:
    ...
    index: int = -1
    for i in range(r):
        index, digit = biggest_digit(line[index + 1:len(line) - (r - i)])
        if index == -1:
...
if __name__ == "__main__":
    result: int = sum_of_banks(get_file_lines("day3/input.txt"), 2)
    print(result)
